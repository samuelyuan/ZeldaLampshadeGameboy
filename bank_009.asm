...
GraveyardDialogue:: ; 0x5329
    db $20, $00, $04, $00, $04, $00, $00, $0f, $f8, $07, $00, $00, $00
...
GraveyardEntry::    ; bank 9 0x5461 
    ...
    db $06, $03, $00, $05
    db $00, $09, $0a, $78
    db $0a, $97, $41, $08 ; bank 0a: 0x4197 tiles
    db $79, $5d, $04, $b4
    db $7f, $09, $26, $53
    db $07, $52, $5a, $00
    db $00, $00
...
PCWorldEntry::    ; bank 9 0x55a0 
    ...
    db $05, $02, $00, $04
    db $00, $09, $0a, $78
    db $0a, $07, $42, $08 ; bank 0a: 0x4207 tiles
    db $e1, $5e, $04, $b4
    db $7f, $09, $26, $53
    db $07, $14, $5c, $00
    db $00, $00
...
McdonaldsEntry::    ; bank 9 0x56ab 
    ...
    db $04, $02, $00, $03
    db $00, $09, $0a, $78
    db $0a, $15, $42, $08 ; bank 0a: 0x4215 tiles
    db $49, $60, $04, $b4
    db $7f, $09, $26, $53
    db $07, $95, $5d, $00
    db $00, $00
...
JRInsideEntry::    ; 0x57b6 
    ...
    db $04, $01, $00, $03
    db $00, $09, $0a, $78
    db $0a, $31, $42, $08 ; bank 0a: 0x4231 tiles
    db $b1, $61, $04, $b4
    db $7f, $09, $26, $53
    db $07, $16, $5f, $00
    db $00, $00
...
JTHouseInsideEntry::    ; 0x5929 
    ...
    db $06, $01, $00, $04
    db $00, $09, $0a, $78
    db $0a, $a5, $41, $08 ; bank 0a: 0x41a5 tiles
    db $19, $63, $04, $b4
    db $7f, $09, $26, $53
    db $07, $97, $60, $00
    db $00, $00
...
DimHouseInsideEntry::    ; bank 9 0x5a34 
    ...
    db $04, $01, $00, $03
    db $00, $09, $0a, $78
    db $0a, $cf, $41, $08 ; points to bank 0a: 0x41cf tiles
    db $81, $64, $04, $b4
    db $7f, $09, $26, $53
    db $07, $18, $62, $00
    db $00, $00
...
RoomBeforeLampshadeBossEntry::    ; bank 9 0x5a6f 
    ...
    db $00, $01, $00, $00
    db $00, $09, $0a, $78
    db $0a, $77, $42, $08 ; points to bank 0a: 0x4277 tiles
    db $e9, $65, $04, $b4
    db $7f, $09, $26, $53
    db $03, $e1, $7f, $00
    db $00, $00
...
LampshadeBossRoomEntry::    ; 0x5bbc 
    ...
    db $03, $00, $00, $02
    db $00, $09, $0a, $78
    db $0a, $69, $42, $08 ; points to bank 0a: 0x4269 tiles
    db $51, $67, $04, $b4
    db $7f, $09, $26, $53
    db $09, $46, $5b, $00
    db $00, $00
...
DefeatedLampshadeBossScreenEntry::    ; 0x5cf0 
    ...
    db $03, $00, $00, $02
    db $00, $09, $0a, $78
    db $0a, $5b, $42, $08 ; bank 0a: 0x425b tiles
    db $bf, $68, $04, $b4
    db $7f, $09, $26, $53
    db $09, $93, $5c, $00
    db $00, $00
...
TempleLightOutsideEntry::    ; 0x5d93 
    ...
    db $02, $02, $00, $01
    db $00, $09, $0a, $78
    db $0a, $93, $42, $08 ; bank 0a: 0x4293 tiles
    db $27, $6a, $04, $b4
    db $7f, $09, $26, $53
    db $07, $99, $63, $00
    db $00, $00
...
TempleLightInsideEntry::    ; 0x5e6b 
    ...
    db $02, $02, $00, $01
    db $00, $09, $0a, $78    
    db $0a, $85, $42, $08 ; bank 0a: 0x4285 tiles
    db $8f, $6b, $04, $b4
    db $7f, $09, $26, $53
    db $09, $36, $5e, $00
    db $00, $00
...
JTHouseOutsideEntry:: ; bank 9 0x5f76 
    ...
    db $04, $04, $00, $03
    db $00, $09, $0a, $78
    db $0a, $b3, $41, $08 ; bank 0a: 0x41b3 tiles
    db $f7, $6c, $04, $b4
    db $7f, $09, $26, $53
    db $07, $1a, $65, $00
    db $00, $00
...
bank009_5fb1: ; title screen
    ...
    db $00, $00, $ff, $fc, $33, $ff, $fc, $55, $44, $c3, $0a, $04, $53, $84, $10, $14
...
TitleScreenEntry:: ; bank 09: 0x5fe3
    ...
    db $00, $00, $00, $00
    db $00, $09, $0a, $78
    db $0a, $af, $42, $08 ; bank 0a: 0x42af tiles
    db $5f, $6e, $04, $b4
    db $7f, $09, $26, $53
    db $09, $b1, $5f, $00
    db $00, $00 
...
GameFinishedScreenEntry:: ; 0x601e
    ...
    db $00, $00, $00, $00
    db $00, $09, $0a, $78
    db $0a, $a1, $42, $08 ; bank 0a: 0x42a1 tiles
    db $c7, $6f, $04, $b4
    db $7f, $09, $26, $53
    db $0a, $ad, $43, $00
    db $00, $00
...
WellEntry:: ; bank 9 0x6191
    ...
    db $06, $03, $00, $05
    db $00, $09, $0a, $78
    db $0a, $c1, $41, $08 ; bank 0a: 0x41c1 tiles
    db $2f, $71, $04, $b4
    db $7f, $09, $26, $53
    db $07, $eb, $66, $00
    db $00, $00
...
DimHouseOutsideEntry:: ; 0x6234 
    ...
    db $02, $03, $00, $01
    db $00, $09, $0a, $78
    db $0a, $dd, $41, $08 ; bank 0a: 0x41dd tiles
    db $97, $72, $04, $b4
    db $7f, $09, $26, $53
    db $07, $99, $68, $00
    db $00, $00
...
NgHeadquartersOutsideEntry:: ; 0x630b 
    ...
    db $03, $03, $00, $02
    db $00, $09, $0a, $78
    db $0a, $f9, $41, $08 ; bank 0a: 0x41f9 tiles
    db $ff, $73, $04, $b4
    db $7f, $09, $26, $53
    db $07, $1a, $6a, $00
    db $00, $00
...
OutsideShopEntry:: ; bank 9 0x6346 
    ...
    db $09, $06, $00, $07
    db $00, $09, $0a, $78
    db $0a, $23, $42, $08 ; bank 0a: 0x4223 tiles
    db $67, $75, $04, $b4
    db $7f, $09, $26, $53
    db $07, $6f, $6d, $00
    db $00, $00
...
JROutsideEntry:: ; bank 9 0x6485 
    ...
    db $05, $03, $00, $04
    db $00, $09, $0a, $78
    db $0a, $3f, $42, $08 ; points to bank 0a: 0x423f tiles
    db $cf, $76, $04, $b4
    db $7f, $09, $26, $53
    db $07, $58, $6f, $00
    db $00, $00
...
BridgeEntry:: ; bank 9 0x6590 
    ...
    db $04, $02, $00, $03
    db $00, $09, $0a, $78
    db $0a, $4d, $42, $08 ; points to bank 0a: 0x424d tiles
    db $37, $78, $04, $b4
    db $7f, $09, $26, $53
    db $07, $ed, $70, $00
    db $00, $00
...
NgHeadquartersInsideEntry:: ; bank 9 0x6667 
    ...
    db $03, $01, $00, $02
    db $00, $09, $0a, $78
    db $0a, $eb, $41, $08 ; bank 0a: 0x41eb tiles
    db $9f, $79, $04, $b4
    db $7f, $09, $26, $53
    db $07, $82, $72, $00
    db $00, $00
